...
const App = () => {
  ...
  useEffect(() => {
    ...
    const isPageReload = navigationEntries.length > 0 && (navigationEntries[0] as PerformanceNavigationTiming).type === 'reload';

    if (isPageReload && lastRefresh) {
    ...
    // If not blocked or not a manual reload, update the last refresh time
  ...
  return (
    <>
      ...
      {isBlocked && (
        <div className="fixed inset-0 z-[99999] bg-[#F8FAFC] flex flex-col items-center justify-center p-6 font-sans">
