    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-[480px] mx-4 overflow-hidden">
        ...
        <div className="px-6 py-5 flex flex-col gap-4 max-h-[70vh] overflow-y-auto">
          ...
          {/* Learning Goal */}
          <div>
            <label className="block text-xs text-[#374151] mb-1.5" style={{ fontWeight: 500 }}>Learning Goal</label>
            <input
              type="text"
              value={learningGoal}
          ...
          {/* Level */}
          <div>
            <label className="block text-xs text-[#374151] mb-1.5" style={{ fontWeight: 500 }}>Level</label>
            <select
              value={level}
              onChange={e => setLevel(e.target.value)}
              className="w-full px-3 py-2.5 bg-white border border-[#E5E7EB] rounded-xl text-sm text-[#111827] focus:outline-none focus:border-[#E11D48] focus:ring-2 focus:ring-[#E11D48]/15 transition-colors"
            >
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2.5 bg-white border border-[#E5E7EB] rounded-xl text-sm text-[#111827] placeholder:text-[#9CA3AF] focus:outline-none focus:border-[#E11D48] focus:ring-2 focus:ring-[#E11D48]/15 transition-colors resize-none"
            />
          </div>
                  ...
                  {profile.role === 'Learner' && (
                    <>
                      <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#E0F2FE] border border-[#BAE6FD] text-[#0369A1] text-xs font-semibold">
                        <GraduationCap className="w-3.5 h-3.5 text-[#0369A1]" />
                        Goal: {profile.learningGoal || 'Not set'}
                      </span>
