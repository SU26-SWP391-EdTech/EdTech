              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className={`text-sm truncate ${
                    lesson.state === 'current' ? 'text-[#E11D48]' : lesson.state === 'locked' ? 'text-[#9CA3AF]' : 'text-[#374151]'
  ...
  return (
    <main className="max-w-[1440px] mx-auto px-8 py-8">
      ...
      <div className="flex items-center gap-2 text-sm text-[#6B7280] mb-6">
        <span className="hover:text-[#111827] cursor-pointer">Learning Paths</span>
        <ChevronRight className="w-4 h-4" />
        <span className="hover:text-[#111827] cursor-pointer">Frontend Development</span>
        <ChevronRight className="w-4 h-4" />
