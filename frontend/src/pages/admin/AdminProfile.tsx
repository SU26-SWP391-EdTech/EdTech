...
import { EditProfileModal, ProfileData } from '../../components/AdminProfile/EditProfileModal';
...
export function AdminProfile() {
    ...
    useEffect(() => {
        let active = true;
        const load = async () => {
            // Microtask delay to avoid calling setState synchronously within effect
